...
namespace ILLink.RoslynAnalyzer.Tests
{
	public abstract class TestCaseUtils
	{
		...
		public static async Task RunTestFile (string suiteName, string testName, params (string, string)[] msbuildProperties)
		{
			...
			var testDirectoryPath = Path.Combine (rootSourceDir, suiteName);
			var testPath = Path.Combine (testDirectoryPath, $"{testName}.cs");
			...
			var additionalFiles = GetAdditionalFiles (testDirectoryPath, tree);
